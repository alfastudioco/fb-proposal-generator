...
- **Chat-edit instructions on very large proposals** (many rooms with detailed scope, or a long Terms & Conditions block) can hit the model's output limit and fail with a truncation error — try a narrower instruction or split the edit into smaller steps.
